...
<body>
    ...
    <li class="cur" ><a href="usertender!msglist.action">我的投标信息</a></li>
    ...
    <div class="main-block">
    <ul class="tender-msg-list">
    <c:if test="${empty page.list}">
    <li style="height:35px;line-height:30px;" >没有相关信息</li>
    </c:if>

    <c:forEach var="item" items="${page.list}" >
    <li>
    <div class="td-name-ctr box" >
    <a href="business!show.action?id=${item.tenderId}">${item.tenderName}</a>
    <span>${item.guestTime}</span>
    </div>
    ...
    <pg:pager url="usertender!msglist.action" items="${page.totalRecords}" maxPageItems="15" export="currentPageNumber=pageNumber">
    <pg:first>
    <a href="${pageUrl}">首页</a>
    </pg:first>
    <pg:prev>
