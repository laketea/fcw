...
<body>
    ...
    <li ><a href="userfile!rewardlist.action">我的悬赏</a></li>
    <li class="cur"  ><a href="userfile!reward.action">发布悬赏</a></li>
    </ul>
    ...
    <form action="userfile!publishReward.action" method="post" >
    ...
    <table class="data upload-data">
     <tbody>
        <tr>
            ...
            <td align="left">
                <input type="text" name="reward.title"  />
            </td>
        </tr>
    ...
    <tr>
    <th align="right">悬赏币:</th>
    <td align="left">
    <input type="text" name="reward.gold"  size="15" />
    </td>
    </tr>

    <tr>
    <th align="right">悬赏分类:</th>
    <td align="left">
    ...
    <td align="left" colspan="2" style="padding-left:160px;height:50px">
        <button class="blue-btn">发布悬赏</button>
    </td>
    </tr>
