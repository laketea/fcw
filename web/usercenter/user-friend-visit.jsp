...
<body>
    ...
    <li class="cur"><a href="userfriend!visit.action">我的访客</a></li>
    ...
    <a class="friend-name" href="#">${visitName}</a>
    <span class="friend-sd" >${visitTime}</span><span class="friend-sd">|</span><span class="friend-sd"><a href="#" >加为好友</a></span>
    </li>
    </c:forEach>
    ...
    <pg:pager url="userfriend!visit.action" items="${page.totalRecords}" maxPageItems="15" export="currentPageNumber=pageNumber">
    <pg:first>
    <a href="${pageUrl}">首页</a>
    </pg:first>
    <pg:prev>
