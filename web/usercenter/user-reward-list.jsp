...
<body>
    ...
    <li class="cur"  ><a href="userfile!rewardlist.action">我的悬赏</a></li>
    <li  ><a href="userfile!reward.action">发布悬赏</a></li>
    </ul>
    ...
    <tr>
        <td colspan="5" align="center" style="height:35px;line-height:30px;">没有相关悬赏</td>
    </tr>
    </c:if>
