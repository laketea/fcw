...
<body>
    ...
    <ul class="uc-nav box">
    <li class="cur" ><a href="usertender!list.action">我发布的招标信息</a></li>
    <li ><a href="usertender!msglist.action">我的投标信息</a></li>
    <li><a href="user-tender-publish.jsp">发布招标</a></li>
    </ul>
    ...
    <tbody>
    <tr>
    <th align="left">招标名称</th>
    <th width="10%">查看次数</th>
    <th width="25%">发布时间</th>
    </tr>
    <c:if test="${empty page.list}">
    <tr>
        <td colspan="5" align="center" style="height:35px;line-height:30px;">没有相关信息</td>
    </tr>
    </c:if>

    <c:forEach var="item" items="${page.list}" >
    <tr>
    <td align="left"><a href="business!show.action?id=${item.id}">${item.name}</a></td>
    <td align="center">${file.viewCount}</td>
    <td align="center">${file.pbTime}</td>
    </tr>
    </c:forEach>
    ...
    <pg:pager url="usertender!list.action" items="${page.totalRecords}" maxPageItems="15" export="currentPageNumber=pageNumber">
    <pg:first>
    <a href="${pageUrl}">首页</a>
    </pg:first>
    <pg:prev>
