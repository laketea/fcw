...
%>
        ...
        <a class="link_01" target="_blank" href="../fcnews!index.action">房产资讯</a> 
        </div>
        <div class="titleheaderwrap">
        <form id="newschannelForm" action="newschannel!search.action" method="post">
        <div class="titleheader22">资讯搜索
        
        <input type="text"  value="${keywords}" name="keywords" class="but_11">
        ...
        <pg:pager url="newschannel!search.action" items="${page.totalRecords}" maxPageItems="15" export="currentPageNumber=pageNumber">
