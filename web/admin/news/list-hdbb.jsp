...
<form id="pagerForm" method="post" action="news!hdbblist.action">
...
<form method="post" action="news!hdbblist.action" onsubmit="return navTabSearch(this)">  
...
<div class="pageContent">  
    <div class="panelBar">  
        <ul class="toolBar">  
               <li><a class="add"  mask="true" target="dialog" width="800" height="540" href="news!add.action?chlId=6"  ><span>
新建新闻</span></a></li>
    <li><a class="add"  mask="true" target="dialog" width="800" height="540" href="news!add.action?chlId=6&operType=3"  ><span>
    新建URL新闻</span></a></li>
